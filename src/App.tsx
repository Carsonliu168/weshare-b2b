...
const stages = [
  ...
  },
  {
    ...
    detail:
      '追蹤造訪客戶網站的企業 IP 特徵，對點擊 PR 連結的匿名買家進行企業域名反向追蹤，自動通知業務團隊並彙整進戰情報告，即時掌握潛在商機。',
  },
];
...
function FAQSection() {
  ...
  const faqs = [
    ...
    {
      q: '維訊的成效報告包含哪些內容？',
      a: '維訊定期交付的成效報告包含：全球媒體刊登清單與連結、各地區媒體覆蓋範圍摘要、以及 AI 買家意圖追蹤重點整理。進階方案以上另含買手情報更新與市場動態摘要；旗艦版以上再納入全球展會通路夥伴與競爭情報彙整。報告格式固定清晰，方便客戶內部呈報或補助核銷使用。'
    },
    {
      q: '我還需要花錢參加國際展會嗎？',
